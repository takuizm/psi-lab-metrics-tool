...
- コマンドライン: `python -m src.cli.psi_main --strategy both`
- 設定確認のみ: `python -m src.cli.psi_main --dry-run`
- 一時的なターゲット差し替え: `python -m src.cli.psi_main --targets-csv ./tmp/targets_test.csv`
